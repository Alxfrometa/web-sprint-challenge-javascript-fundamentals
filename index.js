...
const zooAnimals = [
 ...
 const low = zooAnimals.map(function lowerCaseNames(item){
...
const lowPop = zooAnimals.filter(function lowPopulationAnimals(item){
  ...
  */
  ...
  const totalAnimals = zooAnimals.reduce(function USApop(acc, item){
